...
func GetUserById(userId int) (user *fund.User, err error) {
...
func GetUserByAccount(account string) (user *fund.User, err error) {
	req := contract.NewApiRequest()
...
func GetUserByUID(uid int64) (user *fund.User, err error) {
	req := contract.NewApiRequest()
	req.RequestData = uid

...
func InitConfig(configFile string) *AppConfig {
	...
	CurrentConfig.Boundgroupqrylogin=GetAppConfig("Boundgroupqrylogin")

	CurrentConfig.QueryUserRiskInfo=GetAppConfig("QueryUserRiskInfo")

	CurrentConfig.YqqApiNewLiveInfoUrl=GetAppConfig("YqqApiNewLiveInfoUrl")

	CurrentConfig.YqqApiAllLiveInfoUrl=GetAppConfig("YqqApiAllLiveInfoUrl")

	CurrentConfig.YqqApiAllQuestionUrl=GetAppConfig("YqqApiAllQuestionUrl")

	CurrentConfig.YqqApiMyQuestionUrl=GetAppConfig("YqqApiMyQuestionUrl")

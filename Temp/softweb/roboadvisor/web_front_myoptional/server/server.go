...
func StartServer(configPath string) error {
	...
	cookieName := session.DefaultSessionCookieName + "_myoptional"
	storeConfig := _cache.GetSessionRedisConfig(protected.SessionRedisConfig, sessionExpire, "myoptional", cookieName)

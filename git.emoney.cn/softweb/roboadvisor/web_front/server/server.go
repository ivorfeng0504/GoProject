...
func StartServer(configPath string) error {
	...
	cookieName := session.DefaultSessionCookieName + "_webfront"
	storeConfig := _cache.GetSessionRedisConfig(protected.SessionRedisConfig, sessionExpire, "webfront", cookieName)
